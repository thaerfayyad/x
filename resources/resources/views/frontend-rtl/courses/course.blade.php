                ...
                <div class="col-md-9">
                    ...
                    <div class="course-details-item border-bottom-0 mb-0">
                        ...
                        <div class="course-single-text">
                            ...
                            <div class="course-details-content" style="text-align: right; direction: rtl">
                                <p>
                                    {!! $course->description !!}
                                </p>
                            </div>
                    ...
                    <div class="side-bar">
                        <div class="course-side-bar-widget">
                            ...
                            @if ($courseExpire==false && !$purchased_course && $matched['matched']==false && $matched['matchedBundle']==false)
                                <h3 >
                                    @if($course->free == 1)
                                        <span class="hide"> {{trans('labels.backend.courses.fields.free')}}</span>
                                    @else
                                        {!!  $course->CoursePageStrikePrice  !!}
                                        @lang('labels.frontend.course.price')<span>   {{$appCurrency['symbol'].' '.$course->price}}</span>
                                    @endif</h3>

                                @if(auth()->check() && (auth()->user()->hasRole('employee||company admin')) && (Cart::session(auth()->user()->id)->get( $course->id)))
                                ...
                                @elseif(!auth()->check())
                                    ...
                                    @endif
                                @elseif(auth()->check() && (auth()->user()->hasRole('employee||company admin')))
