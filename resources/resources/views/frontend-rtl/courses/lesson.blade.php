...
@section('content')
    ...
    <div class="course-title mt10 headline  mt-5 ml-5">
        <h3>
            <b>{{ $lesson->title }} </b>
        </h3>
    </div>
        ...
        <div class="container-fliud ">
            ...
            <div class="row main-content">
                ...
                <div class="col-md-6">
                    ...
                    <hr />  --}}
                        @if (!is_null($test_result))
                                ...
                                @foreach ($lesson->questions as $question)
                                    ...
                                    <ul class="options-list pl-4 ">
                                        @foreach ($question->options as $option)
                                            <li
                                                class="@if (($option->answered($test_result->id) != null && $option->answered($test_result->id) == 1) ||
                            ...
                            @endif
                        @else
                            <div class="test-form text-right">
                                @if (count($lesson->questions) > 0)
                                    <form action="{{ route('lessons.test', [$lesson->slug]) }}" method="post">
                                        ...
                                        <div class="radio text-right">
                                                ...
                                                <span class="cr" ><i class=" ">{{  $loop->iteration }}</i></span>
                ...
                <div class="col-md-3 ">
                    ...
                    <div class="course-details-item border-bottom-0 mb-0 px-3">
                        @if ($lesson->lesson_image != '')
                            <div class="course-single-pic mb30" style="margin-top: -70px">
