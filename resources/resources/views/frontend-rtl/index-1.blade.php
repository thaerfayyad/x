...
@auth
        ...
        @if(isset($sections->search_section)&&$sections->search_section->status == 1)
        ...
        @if(isset($sections->popular_courses)&&$sections->popular_courses->status == 1)
            @include('frontend.layouts.partials.popular_courses')
        @endif

        @if(((isset($sections->reasons))||(isset($sections->testimonial)))&&(($sections->reasons->status != 0) || ($sections->testimonial->status != 0)))
        ...
        @if(isset($sections->latest_news)&&$sections->latest_news->status == 1)
        ...
        @if(isset($sections->sponsors)&&$sections->sponsors->status == 1)
            @if(count($sponsors) > 0 )
        ...
        @if(isset($sections->featured_courses)&&$sections->featured_courses->status == 1)
        ...
        @if(isset($sections->teachers)&&$sections->teachers->status == 1)
        ...
        @if(isset($sections->faq)&&$sections->faq->status == 1)
            <!-- Start FAQ section
            ============================================= -->
        ...
        @if(isset($sections->course_by_category)&&$sections->course_by_category->status == 1)
        ...
        @if(isset($sections->contact_us)&&$sections->contact_us->status == 1)
