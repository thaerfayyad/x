...
@section('title', trans('labels.backend.upload.imgaes') . ' | ' . app_name())
...
@section('content')
    ...
    <!-- Start of breadcrumb section
        ============================================= -->
    <section id="breadcrumb" class="breadcrumb-section relative-position backgroud-style" style="background-image: url('{{ asset('$cover->gallery_path')}}');" >
                                ...
                                <div class="best-course-pic relative-position"
                                    ...
                                    <div class="course-price text-center gradient-bg hide">
                                      ...
                                      <div class="course-details-btn">
                                        <a class="text-uppercase" href="{{ route('showGallery',$item->id) }}" target="_BLANK">Show Image<i
