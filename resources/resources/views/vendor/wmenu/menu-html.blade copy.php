    ...
    <script>
        ...
        $(menu).each(function (key, value) {
            ...
            if ((value.id == "") || (value.id == 0)) {
                ...
                $('select#location_' + value.location).siblings('a').attr('href', "{{url('user/menu-manager')}}/{{ $company }}").text('Create New');
            } else {
                $('select#location_' + value.location).val(value.id).attr('selected', true).siblings('a').attr('href', "{{url('user/menu-manager')}}/{{ $company }}?menu=" + value.id)
            }
        ...
        $('#menu-locations-wrap').find('select').on('change', function () {
            if ($(this).val() == "") {
                ...
                $(this).siblings('a').attr('href', "{{url('user/menu-manager')}}/{{ $company }}").text('Create New');
            } else {
                $(this).siblings('a').attr('href', "{{url('user/menu-manager')}}/{{ $company }}?menu=" + $(this).val()).text('Edit')
