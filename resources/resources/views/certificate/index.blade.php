...
<head>
    ...
    <style>
        @font-face {
            ...
            src:({{public_path('/fonts/lobster/LobsterTwo-Bold.ttf')}}) format('truetype'),
            ({{public_path('/fonts/lobster/LobsterTwo-BoldItalic.ttf')}}) format('truetype'),
            ({{public_path('/fonts/lobster/LobsterTwo-Italic.ttf')}}) format('truetype'),
            ({{public_path('/fonts/lobster/LobsterTwo-Regular.ttf')}}) format('truetype'),
        }
