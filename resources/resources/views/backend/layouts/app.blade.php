...
@if(config('app.display_type') == 'rtl' || (session()->has('display_type') && session('display_type') == 'rtl'))
    ...
    @else
        ...
        <body class="{{ config('backend.body_classes') }} hold-transition sidebar-mini">
        ...
        <div class="wrapper "   >
            ...
            @if((config('app.display_type') == 'rtl') || (session('display_type') == 'rtl'))
            <div class="content-wrapper" style="  margin-right:270px ; margin-left:100px  " >
                    @else
                <div class="content-wrapper" style="  margin-right:100px ; margin-left:250px  " >
            @endif
