...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="page-title d-inline">@lang('labels.backend.general_settings.mail_setting')</h3>
                </div>
            </div>
        </div>
        <form action="{{ route('admin.mail-settings-update',1) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card-body"  >
                ...
                <div class="row">
                    {{--  <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                            ...
                            <input type="text" name="subject_ar"  class="form-control" value="{{ $items->subject_ar }}">
                        </div>
                    </div>  --}}
                    {{--  <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                            <label>العنوان بالانجلزية</label>
                            <input type="text" name="subject_en"  class="form-control" value="{{ $items->subject_en }}">
                        </div>
                    </div>  --}}
                    {{--  <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                            <label>الوصف بالعربية</label>
                            <textarea  name="description_ar"  class="form-control"  >{{$items->description_ar }}</textarea>

                        </div>
                    </div>  --}}
                    {{--  <div class="col-sm-12 col-lg-6">
                        <div class="form-group row">
                            <label>الوصف بالانجلزية</label>
                            <textarea  name="description_en"  class="form-control"  >{{$items->description_en }}</textarea>
                        </div>
                    </div>  --}}
                    <div class="col-md-8">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                              ...
                              <img src="{{ $items->image_path}}" style="width: 1000px" class="img-thumbnail image-preview" alt="">
                        </div>
