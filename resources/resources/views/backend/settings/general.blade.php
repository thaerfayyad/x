    ...
    <div class="card">
        <div class="card-body">
                ...
                <div class="form-group row">        
                    <div class="col-md-4">
                        <select type="text" id="company_id" name="company_id" class="form-control js-example-placeholder-single select2"  aria-invalid="false">
                            ...
                            <option value="{{$company->id}}" {{ $company->id==$company_id?'selected':''}}>{{$company->company_name}}</option>
                            @endforeach
                        </select>
                    </div><!--col-->
                </div><!--form-group-->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="nav main-nav-tabs nav-tabs">
                        ...
                        <li class="nav-item">
                            <a data-toggle="tab" class="nav-link" href="#ad_settings">
                                Active Integration
                            </a>
                        </li>
                        {{-- @if($logged_in_user->isAdmin())
            ...
            <div class="tab-content">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8 offset-md-2">
                                    <div id="favicon_image_preview" class="d-inline-block p-3 preview">
                                        <img height="50px" src="{{asset('storage/logos/'.$logged_in_user->favicon_image)}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="layout" class="tab-pane container fade">
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            ...
                            @if(config('company_id')!=1)
                                    <input type="hidden" name="theme_layout" id="theme_layout" value="1" />
                            @else
                            <div class="form-group row">
                ...
                <div id="ad_settings" class="tab-pane container fade">
                    <div class="row mt-2 mb-4">
                        <div class="col-12 mb-2">
                            <h4>Active Integration</h4>
                        </div>
                        <input type="hidden" id="registration_fields" name="registration_fields">

                        <div class="col-lg-9 input-boxes col-12">
                            <div class="form-group row">
                                {{ html()->label('Server Url')->class('col-md-2 form-control-label')->for('server') }}
                                <div class="col-md-10">
                            ...
                            <div class="form-group row">
                                {{ html()->label('Domain User')->class('col-md-2 form-control-label')->for('email_Access') }}
                                <div class="col-md-10">
                                <input type="text" id="email_Access" name="email_Access"
                                       placeholder="Domain User"
                                       value="{{config('email_Access')}}"
                                       class="form-control">
                                </div>
                            </div><!--form-group-->
                            <div class="form-group row">
                                {{ html()->label('Password')->class('col-md-2 form-control-label')->for('password_Access') }}
                                <div class="col-md-10">
                                <input type="password" id="password_Access" name="password_Access"
                                       placeholder="password_Access"
                                       value="{{config('Password Access')}}"
                                       class="form-control">
                                </div>
                            </div><!--form-group-->
                            <div class="form-group row">
                                <div class="input-group-append col-12 my-3 text-center" id="button-addon3">
                                    <button class="btn btn-primary create_employee m-auto"
                                            type="button">Pull Employees</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
//              e.preventDefault();
            ...
            //===== Company value on change ==========//
            $(document).on('change', '#company_id', function () {
                location.href = '{{ route('admin.general-settings')}}/'+$(this).val();
            });
...
//              e.preventDefault();
        ...
        $(document).on('click', '.create_employee', function () {
            let data = {
                ...
                'email_Access' : $('#email_Access').val(),
                'company' : {{ $company_id }},
                'password_Access' : $('#password_Access').val(),
                _token: '{{csrf_token()}}'
            }
            $.ajax({
                url: '{{ route('admin.pull_employee') }}',
                type: 'POST',
                dataType: 'JSON',
                data: data,
