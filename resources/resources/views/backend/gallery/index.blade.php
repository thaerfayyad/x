...
@section('title', __('labels.backend.upload.imgaes').' | '.app_name())
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline"> @lang('labels.backend.upload.imgaes')</h3>
                            ...
                            @foreach($gallerys as $key=>$item)
                                ...
                                <tr style="text-align: center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.gallerys.edit', $item->id) }}"
                                        ...
                                        <a data-method="delete" data-trans-button-cancel="Cancel"
                                           ...
                                           onclick="$(this).find('form').submit();">
                                            ...
                                            <form action="{{route('admin.gallerys.destroy',$item->id)}}"
