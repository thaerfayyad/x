            ...
            <div class="row hide">
                <div class="col-12 form-group">
                    <div class="checkbox d-inline mr-3">
                        ...
                        <input type="checkbox" class="single" name="published" value="1" />
                    ...
                    <div class="checkbox d-inline mr-3">
                        ...
                        <input type="checkbox" class="single" name="featured" value="1" />
                    ...
                    <div class="checkbox d-inline mr-3">
                        ...
                        <input type="checkbox" class="single" name="trending" value="1" />
                    ...
                    <div class="checkbox d-inline mr-3">
                        ...
                        <input type="checkbox" class="single" name="popular" value="1" />
                    ...
                    <div class="checkbox d-inline mr-3">
                        {!! Form::hidden('free', 1) !!}
                        <input type="checkbox" class="single" name="free" value="1" />
