...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a href="{{route('admin.bundles.index',['company'=>$company])}}" class="btn btn-primary float-right">@lang('labels.general.back')</a>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <table class="table table-bordered table-striped">
                            ...
                            <td>
                                @if($bundle->published == 1)
                                    {{-- <a class="text-decoration-none"  target="_blank"
                                       href="{{ route('bundles.show', ['bundle' => $bundle->slug,'company'=>$company]) }}">{{ $bundle->title }}</a> --}}
                                       <a class="text-decoration-none"  target="_blank"
                                       href="">{{ $bundle->title }}</a>
                                @else
                                    {{ $bundle->title }}
                        ...
                        <tr>
                            ...
                            <td>{{ $bundle->category?$bundle->category->name:'' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <input type="checkbox" {{ $bundle->published == 1 ? 'checked' : ''  }} class="single" disabled name="published" value="1" />
                        </tr>
                        <tr>
