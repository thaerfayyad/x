    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-2 d-flex form-group flex-column">
                    OR <a target="_blank" class="btn btn-primary mt-auto"
                          href="{{route('admin.courses.create',['company' => $company])}}">{{trans('labels.backend.bundles.add_courses')}}</a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-2 d-flex form-group flex-column">
                    OR <a target="_blank" class="btn btn-primary mt-auto"
                          href="{{route('admin.categories.index',['company' => $company]).'?create'}}">{{trans('labels.backend.bundles.add_categories')}}</a>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 form-group hide">
            ...
            <div class="row hide">
                <div class="col-12 form-group">
                    <div class="checkbox d-inline mr-4">
                        ...
                        <input type="checkbox" class="single" name="published" value="1" {{ $bundle->published==1 ? 'checked' : '' }} />
                    ...
                    <div class="checkbox d-inline mr-4">
                        ...
                        <input type="checkbox" class="single" name="featured" value="1" {{ $bundle->featured==1 ? 'checked' : '' }} />
                    ...
                    <div class="checkbox d-inline mr-4">
                        ...
                        <input type="checkbox" class="single" name="trending" value="1" {{ $bundle->trending==1 ? 'checked' : '' }} />
                    ...
                    <div class="checkbox d-inline mr-4">
                        ...
                        <input type="checkbox" class="single" name="popular" value="1" {{ $bundle->popular==1 ? 'checked' : '' }}  />
                    ...
                    <div class="checkbox d-inline mr-4">
                        ...
                        <input type="checkbox" class="single" name="free" value="1" {{ $bundle->free==1 ? 'checked' : '' }}  />
