...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <input type="hidden" name="company_id" value="{{ $course->company_id?$course->company_id:$company }}" />
            ...
            <div class="row">
                ...
                <div class="col-2 d-flex form-group flex-column">
                    OR <a target="_blank" class="btn btn-primary mt-auto"
                          href="{{route('admin.categories.index',['company' => $company]).'?create'}}">{{trans('labels.backend.courses.add_categories')}}</a>
                </div>
            </div>
            <div class="row">
