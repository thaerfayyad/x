...
@endpush
@section('content')
    {{ html()->modelForm($slide, 'PATCH', route('admin.sliders.update',['sliders'=>$slide->id,'company'=>$company]))->class('form-horizontal')->acceptsFiles()->id('slider-create')->open() }}
    @method('PUT')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.sliders.index',['company'=>$company]) }}"
        ...
        <div class="card-body">
                ...
                <div class="form-group row">       
                    <div class="col-md-4">
                        <select type="text" id="company_id" name="company_id" class="form-control js-example-placeholder-single select2"  aria-invalid="false">
                            <option value="" selected> {{ __('validation.attributes.backend.access.users.company_name') }} </option>
            ...
            <div class="form-group row justify-content-center">
                <div class="col-4">
                    {{ form_cancel(route('admin.sliders.index',['company'=>$company]), __('buttons.general.cancel')) }}
