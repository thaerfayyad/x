    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.sliders.create',['company'=>$company]) }}"
            ...
            <div class="row">
                ...
                ->checked(($item->status == 1) ? true : false)->class('switch-input')->attribute('data-id', $item->id)->value(($item->status == 1) ? 1 : 0).'<span class="switch-label"></span><span class="switch-handle"></span>')->class('switch switch-lg switch-3d switch-primary')
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.sliders.edit',['slider'=>$item->id,'company'=>$company]) }}"
                                        ...
                                        <a data-method="delete" data-trans-button-cancel="Cancel"
                                           ...
                                           onclick="$(this).find('form').submit();">
                                            ...
                                            <form action="{{route('admin.sliders.destroy',['slider'=>$item->id,'company'=>$company])}}"
            ...
            @if(count($slides_list) > 0)
                <div class="row justify-content-center">
                    <div class="col-6  ">
                        ...
                        <a href="{{ route('admin.courses.index',['company' => Auth()->user()->id]) }}"
