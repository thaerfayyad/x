    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a href="{{ route('admin.categories.create',['company' => $company]) }}"
                    ...
                    <div class="table-responsive">
                        <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.categories.index',['company' => $company]) }}?show_deleted=1"
...
@push('after-scripts')
    <script>
        $(document).on('change', '#company_id', function () {
                location.href = '{{ url('user/categories')}}/'+$(this).val();
            });
        $(document).ready(function () {
            var route = '{{route('admin.categories.get_data')}}?company={{ $company }}';
