...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title d-inline">  @lang('labels.backend.reports.report_details') </h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <table id="myTable" class="table table-bordered table-striped ">
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.reports.progress')</th>
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var course_route = '{{route('admin.reports.get_teachers_data')}}';
