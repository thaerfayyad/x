        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.access.users.company_name'))->class('col-md-2 form-control-label')->for('company_id') }}
                        ...
                        <div class="col-md-10">
                            <select type="text" id="company_id" name="company_id" class="form-control js-example-placeholder-single select2"  aria-invalid="false">
                                <option> {{ __('validation.attributes.backend.access.users.company_name') }} </option>
                                @foreach ($companies as $company)
                                <option value="{{$company->id}}" {{ $user->company_id }} {{ $user->company_id==$company->id?'selected':'' }} >{{$company->company_name}}</option>
                                @endforeach
                            </select>
