                ...
                <div class="col-sm-5">
                    <select name="roles" id="roles" class="form-control d-inline w-75">
                        ...
                        @foreach($roles as $role)
                            @if(auth()->user()->hasRole('company admin')&&$role->id==1)
                            @else
                    ...
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="import_users">
                        <a href="{{ route('admin.auth.user.import_users_index') }}" class="btn btn-success ml-1" data-toggle="tooltip" title="import_users">Import Users</a>
                    </div><!--btn-toolbar-->                    
                </div><!--col-->
            </div><!--row-->
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.teachers.fields.company_name')</th>
                                @endif
