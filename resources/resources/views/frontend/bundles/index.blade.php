                                                    ...
                                                    <div class="best-course-text">
                                                        ...
                                                        <div class="course-meta">
                                                            <span class="course-category"><a
                                                                        href="{{route('courses.category',['category'=>$bundle->category?$bundle->category->slug:' '])}}">{{$bundle->category?$bundle->category->name:''}}</a></span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="course-list-img-text">
                                                            ...
                                                            <div class="course-list-text">
                                                                ...
                                                                <div class="course-meta">
                                                                <span class="course-category bold-font hide"><a
                                                    ...
                                                    <td>
                                                        <div class="course-type-list">
                                                            <span><a href="{{route('courses.category',['category'=>$bundle->category?$bundle->category->slug:' '])}}">{{$bundle->category?$bundle->category->name:''}}</a></span>
                                                        </div>
                                                    </td>
