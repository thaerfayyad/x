                                ...
                                <div class="nav-menu ul-li">
                                    <ul>
                                                    ...
                                                    @if(count($menu->subs) == 0)
                                                        <li class="nav-item">
                                                            <a href="{{asset($menu->link)}}"
                                                               ...
                                                               id="menu-{{$menu->id}}">{{trans('custom-menu.'.$menu->menu.'.'.str_slug($menu->label))}}</a>
                                                        </li>
                                                    @else
                                                        <li class="menu-item-has-children ul-li-block">
                                                            <a href="#!">{{trans('custom-menu.'.$menu->menu.'.'.str_slug($menu->label))}}</a>
                                                            <ul class="sub-menu">
                                        ...
                                        @if(auth()->check())
                                            ...
                                            @else
                                            <li class="menu-item-has-children ul-li-block">
                                                <a href="#!">{{ $logged_in_user->company_name }}</a>
                                                <ul class="sub-menu">
                                                    @can('view backend')
                                                        <li>
                                                            <a href="{{ route('admin.dashboard') }}">@lang('navs.frontend.dashboard')</a>
                            ...
                            <div class="mobile-menu">
                                ...
                                <nav>
                                    <ul>
                                        ...
                                        @if(auth()->check())
                                            <li class="">
                                                <a class="text-dark" href="#!">{{ $logged_in_user->company_name}}</a>
                                                <ul>
                                                    @can('view backend')
                                                        <li>
                                                            <a href="{{ route('admin.dashboard') }}">@lang('navs.frontend.dashboard')</a>
