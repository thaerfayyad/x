...
return array (
  ...
  array (
    ...
    array (
      ...
      'delete_warning' => 'You can not delete course. Employees are already enrolled. Unpublish the course instead',
      'delete_warning_bundle' => 'You can not delete Bundle. Employees are already enrolled. Unpublish the Bundle instead',
      'teacher_delete_warning' => 'You can not delete Company Admin. Courses are already added. Change the status instead',
    ),
    'roles' =>
    array (
