...
<b>Live</b> = Will be used with you Live PayUMoney credentials to make actual transaction with normal users with PayUMoney account.<br><strong>If you set this payment gateway then set your currency as INR</strong>',
      ...
      'custom_js' => 'Custom JS',
      'teacher_commission_rate' => 'Company Admin Commission Rate',
      ...
      'counter' => 'Counter',
      'counter_note' => '<b>Static</b> =  Manually add data for counter. Please enter exact text you want to display on frontend counter section,<br> <b>Database/Real</b> = It will take real data from database for all the fields (Employees enrolled, Total Courses, Total Company Admins)',
      'total_students' => 'Enter Total Employees. Ex: 1K, 1Million, 1000 etc.',
      'total_courses' => 'Enter Total Courses. Ex: 1K, 1000 etc.',
      'total_teachers' => 'Enter Total Company Admins. Ex: 1K, 1000 etc.',
    ...
    array (
      ...
      'edit' => 'Edit Company Admin',
      'view' => 'View Company Admins',
    ),
    'testimonials' =>
    array (
      'fields' =>
    ...
    array (
      ...
      'students' => 'Employees',
      'trending' => 'Trending',
      'teachers' => 'Company Admins',
      'completed' => 'Completed',
      'no_data' => 'No data available',
      'buy_course_now' => 'Buy course now',
      'your_courses' => 'Your Courses',
      'students_enrolled' => 'Employees Enrolled To<br> Your Courses',
    ...
    array (
      ...
      'students_report' => 'Employees Report',
      'bundles' => 'Bundles',
      'courses' => 'Courses',
      'name' => 'Name',
      'progress' => 'Progress',
      ...
      'quiz' => 'Quiz',
      'try' => 'Try',
      'report_details' => 'Detailed Report',
      'total_earnings' => 'Total Earnings',
      'total_sales' => 'Total Sales',
      'date_range' => 'Date Range',
      'select_student' => 'Select Employees',
    ...
    array (
      ...
      array (
        ...
        'remarks' => 'Remarks',
        'date' => 'Date',
        'teacher_name' => 'Company Admin Name',
      ),
    ),
    'live_lessons' => array(
        'title' => 'Live Lesson',
    ...
    'live_lesson_slots' => array(
        ...
        'start_url' => 'Start URL',
        'slot_booked_student_list' => 'Slot Booked Employee List',
  ...
  array (
    ...
    array (
      ...
      'purchase_successful' => 'Congratulations! You\'ve Enrolled this course.',
    ...
    array (
      ...
      'buy_note' => 'Only Employees Can Buy Course',
    ...
    array (
      ...
      array (
        ...
        'sponsors' => 'Sponsors.',
        'students_testimonial' => 'Employees <span>Testimonial.</span>',
    ...
    'modal' =>
    array (
      'new_user_note' => 'New Company ? Register Here',
    ...
    array (
      ...
      'students' => 'Employees',
      'title' => 'Company Admins',
      'courses_by_teacher' => 'Courses <span>By Company Admin.</span>',
      'course_detail' => 'Course Detail',
    ),
    'user' =>
    array (
  ...
  'teacher' =>
  array (
    'teacher_register' => 'Register as Company? Click Here',
    'teacher_register_box_title' => 'Company Admin Register',
