                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                    ...
                                    placeholder="{{ __('str.Search user') }}" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                                            ...
                                            <form id="kt_modal_export_users_form" class="form" action="#">
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <select name="role" data-control="select2"
                                                        ...
                                                        <option></option>
                                                        <option value="Administrator">{{ __('str.Administrator') }}
                                                        </option>
                                                    </select>
                                                    <!--end::Input-->
                                                </div>
                                            ...
                                            <form id="kt_modal_add_user_form" class="form" action="#">
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--begin::Hint-->
                                                        <div class="form-text">
                                                            {{ __('str.Allowed file types: png, jpg, jpeg.') }}</div>
                                                        <!--end::Hint-->
                                                    </div>
                                                    <div class="row">
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="col-md-6 mb-7">
                                                            ...
                                                            <input id="password_confirmation" type="password"
                                                                ...
                                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                                placeholder="********" value="" />
                                                            <strong id="password_confirm_error" class="errors text-danger"
                                                                role="alert">
                                                            </strong>
                                                            <!--end::Input-->
                                                        </div>
                                                        ...
                                                        <strong id="roles_id_error" class="errors text-danger"
                                                            role="alert">
                                                        </strong>
                                                        <!--end::Input group-->
                                                    </div>
