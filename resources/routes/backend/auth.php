...
Route::group([
    ...
    'as'         => 'auth.',
    'namespace'  => 'Auth',
    'middleware' => 'role:administrator||company admin',
    ...
    Route::group(['namespace' => 'User'], function () {
        ...
        Route::post('user/upload', [UserController::class, 'upload_users'])->name('user.upload');
        Route::get('import_users_index', [UserController::class, 'import_users_index'])->name('user.import_users_index');
     ...
     * Role Management
     */
    Route::group(['namespace' => 'Role','middleware' => 'role:administrator'], function () {
