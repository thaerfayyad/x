...
//************Galley Route******************/
Route::get('/galerys', [HomeController::class, 'getGallery'])->name('getGallery');
Route::get('/gallery/{id}', [HomeController::class, 'showGallery'])->name('showGallery');
Route::get('/image-download/{id}', [HomeController::class, 'download'])->name('image-download');

//************Article Route******************/
Route::get('/articles', [HomeController::class, 'getArticle'])->name('getArticle');
...
Route::get('/services', 'Frontend\ContactController@services')->name('services');
...
Route::group(['prefix' => 'laravel-filemanager', 'middleware' => ['web', 'auth','role:company admin|administrator']], function () {
